...
for idx,latlong in enumerate(latlong):
    for i in range(10,19):
        ...
        if datas:
            ...
            json_path = f"s3://ai-pipeline-raw-data/data/data_statistics/kemendesa/sipukat/rtsp/json/{file_name.replace(' ', '_').replace('/', '_')}"
            ...
            StorageManager.save_json(json_path, data)
